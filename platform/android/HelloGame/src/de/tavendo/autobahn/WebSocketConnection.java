...
import com.example.hellogame.WebsocketHandler;
...
public class WebSocketConnection implements WebSocket {
   ...
   public void connect(String wsUri, String wsProtocol, WebsocketHandler wsHandler) throws WebSocketException {
		connect(wsUri, wsProtocol, wsHandler, new WebSocketOptions());
   }
